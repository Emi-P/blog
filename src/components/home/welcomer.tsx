...
const Welcomer: React.FC = () => {
  return (
    <div className="bg-background text-foreground p-6 md:p-12 rounded-lg align-middle self-center text-center grid grid-cols-3 max-h-80">
      <img className="justify-self-end relative lg:right-[38%] right-[15%] bottom-5" src="/blog/gifs/dancingjesus.gif" alt="X" style={{ transform: 'scaleX(-1)' }} />
      ...
      <img className="justify-self-start relative lg:left-[38%] left-[15%] bottom-5" src="/blog/gifs/dancingjesus.gif" alt="X" />
    </div>
  );
};
